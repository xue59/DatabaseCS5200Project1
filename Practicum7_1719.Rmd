...
mydb <- dbConnect(MySQL(), user = 'root', password = 'mlmd3kxfzg', 
                  dbname = 'practicum_try_2', host = 'localhost')
```
...
#the number of bird strikes incidents 
#per year



#2008, take-off/climbing
#2008, descent/approach/landing

#2009, take-off/climbing
#2009, descent/approach/landing

#2010, take-off/climbing
#2010, descent/approach/landing

#2011, take-off/climbing
#2011, descent/approach/landing

# a column chart is oriented vertically. TODO

statement = "SELECT COUNT(record_id) 
FROM record_table
WHERE YEAR(STR_TO_DATE(flight_date,'%m/%d/%Y')) LIKE '2008'
GROUP BY YEAR(STR_TO_DATE(flight_date,'%m/%d/%Y'));"
  
data08_pre <- dbGetQuery(mydb, statement)
num08 <- data08_pre[[1]]
